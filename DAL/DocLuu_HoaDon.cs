...
namespace DAL
{
    public class DocLuu_HoaDon
    {
        public string DuongDan { get; set; }
        public virtual List<HoaDon> DocHoaDon()
        {
        ...
        //ok
        public virtual void LuuDanhSachHoaDon(List<HoaDon> ds)
        {
        ...
        //ok
        public virtual void LuuHoaDonNhap(HoaDon hoaDon)
        {
        ...
        //ok
        public virtual bool SuaHoaDon(HoaDon hoaDon)
        {
        ...
        //ok
        public virtual bool XoaHoaDon(string id)
        {
            List<HoaDon> lstHoaDon = DocHoaDon();
            for (int i = 0; i < lstHoaDon.Count; i++)
            {
